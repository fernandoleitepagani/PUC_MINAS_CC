...
public class Is {
    ...
    /** True se a string tiver somente vogais */
    ...
    /** True se a string for um numero inteiro */
    ...
    /** True se a string for um numero real. */
    ...
    /** Le linhas ate "FIM" e imprime X1 X2 X3 X4 */
    public static void main(String[] args) {
        ...
        while (scanner.hasNextLine()) {
            ...
            /** implementar printf das strings x1,x2,x3,x4*/
        }
        scanner.close();
    }
}
